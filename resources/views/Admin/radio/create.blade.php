...
@section('content')
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <form class="form-horizontal" action="{{ route('radio.store') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            @include('Admin.section.errors')


{{--    todo what is slug        $course->slugvoice = $request->slugvoice;--}}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" name="slug" id="slug" placeholder="ادرس اینترنتی را وارد کنید"
                           value="{{ old('slug') }}">
                </div>
            </div>
            <div class="form-group">
