    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <form class="form-horizontal" action="{{ route('articles.store') }}" method="post"
                    ...
                    <select name="category_id" id="" class="form-control">
                        ...
                        @foreach($categories as $category_data)
                            ...
                            @if(count($category_data->childrenRecursive) > 0)
                                @include('admin.partials.category', ['categories'=>$category_data->childrenRecursive, 'level'=>1])
                            @endif
                        @endforeach
                    </select>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <label for="slug" class="control-label">لینک :</label>
                    <input type="text" class="form-control" name="slug" id="slug" placeholder="لینک را وارد کنید"
                           value="{{ old('slug') }}">
                </div>
            </div>
