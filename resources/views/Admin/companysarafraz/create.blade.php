...
@section('content')
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <form class="form-horizontal" action="{{ route('companysarafraz.store') }}" method="post"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <label for="link" class="control-label">خلاصه :</label>
                    <input type="text" class="form-control" name="link" id="link" placeholder="خلاصه را وارد کنید"
                           value="{{ old('summary') }}">
                </div>
            </div>
