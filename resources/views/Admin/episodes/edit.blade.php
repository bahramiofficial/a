                ...
                <div class="col-sm-6">
                    ...
                    <select class="form-control" name="course_id" id="course_id">
                        @foreach(\App\Models\Course::latest()->get() as $course)
                            <option
                                value="{{ $course->id }}" {{ $course->id == $episode->course_id ? 'selected' : ''}}>{{ $course->title }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-sm-6">
                    <label for="publish" class="control-label">زمان انتشار :</label>
                    <input type="datetime-local" class="form-control" name="publish" id="publish"
                            value="{{ $episode->publish }}">
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    ...
                    <textarea rows="5" class="form-control" name="description" id="description"
                              placeholder="متن مقاله را وارد کنید">{{ $episode->description }}</textarea>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="number" class="form-control" name="number" id="number"
                           placeholder="شماره قسمت را وارد کنید" value="{{ $episode->number }}">
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-6">
