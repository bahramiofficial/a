...
@section('style')
    ...
    <link type="text/css" rel="stylesheet" href="../../../datePersian/jalalidatepicker.min.css" />
@endsection
@section('script')
    ...
    <script src="../../../datePersian/jalalidatepicker.min.js" type="text/javascript"></script>

    <script>
        jalaliDatepicker.startWatch();
        let x = document.getElementById('datepublish')
        x.onchange=function (){
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <form class="form-horizontal" action="{{ route('episodes.store') }}" method="post"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <label for="datepublish" class="control-label">زمان انتشار :</label>
                   {{-- <input data-jdp />--}}
                    <input data-jdp  type="text" class="form-control" name="datepublish" id="datepublish"
                           placeholder="زمان انتشار را وارد کنید" value="{{ old('datepublish') }}">

                    <input class="form-control" type="checkbox" name="publish" id="publish">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" name="number" id="number"
                           placeholder="شماره قسمت را وارد کنید" value="{{ old('number') }}">
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-6">
